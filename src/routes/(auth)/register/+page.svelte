...
<h2 class="text-xl font-bold">Daftar</h2>
<p class="mt-1 text-sm text-surface-500 dark:text-surface-400">Buat akun baru</p>
...
<p class="mt-4 text-center text-sm text-surface-500 dark:text-surface-400">
	Sudah punya akun?
	<a class="font-medium underline underline-offset-2" href="/login">Masuk</a>
</p>
