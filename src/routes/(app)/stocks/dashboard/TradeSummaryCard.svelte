	...
	{#if loading}
		<div class="flex flex-col gap-4" in:fade={{ duration: 200 }}>
			<div class="flex items-center gap-6">
				<div class="skeleton-shimmer h-[130px] w-[150px] rounded-full bg-surface-200 dark:bg-surface-700"></div>
				<div class="flex flex-col gap-2">
					<div class="skeleton-shimmer h-3 w-16 rounded bg-surface-200 dark:bg-surface-700"></div>
					<div class="skeleton-shimmer h-7 w-20 rounded bg-surface-200 dark:bg-surface-700"></div>
				</div>
			</div>
			<div class="skeleton-shimmer h-px w-full bg-surface-200 dark:bg-surface-700"></div>
			<div class="grid grid-cols-2 gap-4">
				<div class="flex flex-col gap-1">
					<div class="skeleton-shimmer h-3 w-28 rounded bg-surface-200 dark:bg-surface-700"></div>
					<div class="skeleton-shimmer h-4 w-32 rounded bg-surface-200 dark:bg-surface-700"></div>
				</div>
				<div class="flex flex-col gap-1">
					<div class="skeleton-shimmer h-3 w-20 rounded bg-surface-200 dark:bg-surface-700"></div>
			...
			<div class="grid grid-cols-2 gap-4">
				...
				<div class="flex flex-col gap-3">
					...
					{#each { length: 3 } as _}
						<div class="flex flex-col gap-1">
							<div class="skeleton-shimmer h-3 w-18 rounded bg-surface-200 dark:bg-surface-700"></div>
